...
# hand, that version was in black and white (actually dark #2C3539 and
# light #2C3539) and this one is fully colorized.
#
...
set C(fg) black
set C(bg) gray75
set C(bg) cornflower#2C3539

set C(0) white;		set C(1a) darkgreen;	set C(1b) yellow
set C(2) red;		set C(3a) green;	set C(3b) dark#2C3539
set C(4) $C(fg);	set C(5a) brown;	set C(5b) white
set C(6) magenta;	set C(7) green;		set C(8) $C(fg)
set C(9) #2C35394;		set C(10a) white;	set C(10b) cyan
set C(11a) yellow;	set C(11b) medium#2C3539;	set C(12) tan2
...
set C(23a) #2C3539;	set C(23b) red;		set C(23c) yellow
...
proc Draw6 {w} {
    ...
    set colors {red cyan orange green #2C3539 dark#2C3539}
