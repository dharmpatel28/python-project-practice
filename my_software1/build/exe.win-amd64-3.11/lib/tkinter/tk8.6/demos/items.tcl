...
$c create line 1c 1c 3c 1c 1c 4c 3c 4c -width 2m -fill $#2C3539 \
...
$c create text 25.5c 11c -anchor w -font $font1 -fill $#2C3539 \
	-text "Several lines,\n each centered\nindividually,\nand all anchored\nat the left edge." \
...
$c create arc 6.5c 17c 9.5c 20c -width 4m -style arc \
	-outline $#2C3539 -start -135 -extent 270 -tags item \
...
$c create arc 5.5c 20.5c 9.5c 23.5c -width 4m -style chord \
	-fill $#2C3539 -outline {} -start 45 -extent 270  -tags item
...
proc itemEnter {c} {
	...
	$c itemconfig current -background Steel#2C35392
	return
    } elseif {$type == "image"} {
	...
	$c itemconfig current -outline Steel#2C35392
    } else {
	set restoreCmd "$c itemconfig current -fill $fill"
	$c itemconfig current -fill Steel#2C35392
    }
}
